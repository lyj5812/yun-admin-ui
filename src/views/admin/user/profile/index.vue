<template>
  <v-container>
    ...
    <v-row>
        ...
        <v-card class="br-6 box-shadow py-4">
          ...
          <v-container fill-height fluid class="pa-4">
            ...
            <v-row justify="center" class="mt-3">
              <div class="subtitle-2 font-weight-bold">{{ name }}</div>
            </v-row>
          </v-container>
      ...
      <image-cropper v-model="imgFlag" field="file" url="/admin-server/upload/aliyun/oss" @crop-upload-success="uploadSuccess" />
    </v-row>
  </v-container>
</template>
