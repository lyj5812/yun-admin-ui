  ...
  <div>
    <v-card class="elevation-4">
      <v-row class="ml-3">
        ...
        <v-col cols="12" xs="12" lg="2" offset-lg="8" class="mt-4">
          <v-btn
      ...
      >
        ...
        <template v-slot:handle="{ item }">
          <v-btn v-perms="['system:menu:edit']" fab x-small class="mt-1 mb-1" color="warning" @click="editMenu(item)">
    ...
    <v-form ref="menu" :model="menu">
      <v-dialog v-model="editFlag" persistent max-width="800px">
        <v-card>
          <v-card-title>
                  ...
                  <template v-slot:append-outer>
                    ...
                    >
                      <template v-slot:activator="{ on }">
                        <v-icon class="ml-1" v-on="on">mdi-help-circle-outline</v-icon>
                      </template>
